...
<main id="content">
    ...
    <div class="media shadow-lg p-3 mb-5 bg-light rounded">
      <img src="img/<?php echo $donnees['image_film']; ?>" class="mr-3" alt="...">
    </div>

    <!-- pour la description du film -->
      <center> <h5 class="mb-1">SYNOPSIS</h5></center>
      ...
      <div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1"></div>
        <div class="col-10 col-sm-10 col-md-10 col-lg-4 col-xl-5">
          ...
          <div class="list-group">
            ...
            <?php
            $reqrealisateur=$bdd->prepare("SELECT * FROM realisateur WHERE id_realisateur =".$_GET['id']);
            ...
            <a href="realisateur.php?id_realisateur=<?php echo $donnees['id_realisateur']; ?>"
             class="list-group-item list-group-item-action">
               <p class="mb-1"><?php echo $donnees['nom_realisateur']; ?>
               </p>
            </a>
            ...
            <?php
            $reqgenre=$bdd->prepare("SELECT DISTINCT g.type FROM genre g, film f, soumettre s WHERE f.id_film=s.id_film AND s.id_genre=g.id_genre AND f.id_film = g.id_genre WHERE id_genre =".$_GET['id']);
            $reqgenre->execute();
            ...
            ?>
              ...
              <a href="#" class="list-group-item list-group-item-action">
                <p class="mb-1"><?php echo $donnees['type']; ?>
                </p>
              </a>
            <?php
            }
            ...
            ?>
          <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-1">DATE DE SORTIE</h5>
              </div>
              <?php
            $requete = $bdd->prepare('SELECT * FROM film WHERE id_film ='.$_GET['id']);
            $requete->execute();
            ...
            ?>
              ...
              <a href="#" class="list-group-item list-group-item-action">
                <p class="mb-1"><?php echo $donnees['date_sortie']; ?>
                </p>
              </a>
              <?php
           }
           ...
           ?>
              ...
              <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-1">ACTEURS/TRICE</h5>
              </div>
            <?php
            $reqacteur=$bdd->prepare("SELECT * FROM acteur WHERE id_acteur =".$_GET['id']);             
            $reqacteur->execute();
  ...
  <?php
      ...
      <div class="col-8 col-sm-8 col-md-8 col-lg-4 col-xl-4"><?php echo $donnees['bande_annonce']; ?>
      <?php
           }
           $requete->closeCursor(); // termine le traitement de la requete 
           ?>
