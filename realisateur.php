...
<body>
  ...
  $requete3 = $bdd->query("SELECT * FROM realisateur");

    // On affiche chaque entrée une à une
  while ($resultat = $requete3->fetch())
  {
  ?>
  ...
  <main id="real">
        ...
        <!--  pour le titre -->
        <div class="hoofd">
          <h1 class="text-uppercase"><?php echo $resultat['nom_realisateur']; ?></h1>
...
<a  class="list-group-item list-group-item-action">
  ...
  <p class="mb-1"><?php echo $resultat['description_realisateur']; ?></p>
...
<a href="#" class="list-group-item list-group-item-action">
  ...
  <p class="mb-1"><?php echo $resultat['filmographie_realisateur']; ?></p>
...
<div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
  ...
  <img src="img/<?php echo $resultat['image_realisateur']; ?>" height="400px" width="300px"></img>
...
$requete3->closeCursor(); // Termine le traitement de la requête
